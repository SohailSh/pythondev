...
#configurating main window
root = Tk()
root.geometry("400x300")
root.title("Sohail's Band Name Generator")
root.resizable(0, 0)
...
#reset function for deleting entry boxes and output labels
def reset():
    entry1.delete(0, tkinter.END)
    entry2.delete(0, tkinter.END)


#rest button calling reset function
